...
altkey     = "Mod1"
terminal   = "lxterminal"
editor     = os.getenv("EDITOR") or "mg" or "vi"
...
-- {{{ Tags
tags = {
   names = { "term", "emacs", "charm", "web", "mail", "other" },
...
for s = 1, screen.count() do
    ...
    --mybottomwibox[s] = awful.wibox({ position = "bottom", screen = s, border_width = 0, height = 5 })
