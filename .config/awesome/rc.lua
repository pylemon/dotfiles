...
for s = 1, screen.count() do
    ...
    -- 自定义 tags 标签名称
    tags[s] = awful.tag(
    	    { "1.Term", "2.Emacs",  "3.FireFox", "4.Chrome", "5.Pidgin", "6.WebQQ", "7.Email"  }, s,
      	    { layouts[5], layouts[10], layouts[10],  layouts[10], layouts[6], layouts[10], layouts[10] }
    )
end
-- }}}
