...
vicious.register(cpupct1, vicious.widgets.cpu, "| cpu $3% ", 2)
...
vicious.register(memused, vicious.widgets.mem,
  "<span color='" .. beautiful.fg_em .. "'>ram </span>$2m ", 5)
...
vicious.register(rootfspct, vicious.widgets.fs, "| disk ${/ used_p}% ", 97)
-- }}}
...
vicious.register(upgraph, vicious.widgets.net, "${eth1 up_kb}")

-- TX
txwidget = wibox.widget.textbox()
vicious.register(txwidget, vicious.widgets.net,
  "<span color='" .. beautiful.fg_em .. "'>up</span>${eth1 tx_mb}MB", 19)
...
vicious.register(rxwidget, vicious.widgets.net,
  "<span color='" .. beautiful.fg_em .. "'>down</span>${eth1 rx_mb}MB", 17)
...
vicious.register(downwidget, vicious.widgets.net, "| ${eth1 down_kb} kB/s |", 2)
-- }}}
